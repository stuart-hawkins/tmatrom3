...
% This example:
%
% 1) Computes the T-matrix of a penetrable spheroid
...
help example_penetrable_spheroid
...
if exist('tmatrix_penetrable_spheroid_example.mat','file')
    
    % load the T-matrix
    T = tmatrix('tmatrix_penetrable_spheroid_example.mat');
...
if loaded_tmatrix
    ...
    fprintf('Warning:\n\n');
    fprintf('Loaded T-matrix from tmatrix_penetrable_spheroid_example.mat.\n');
    fprintf('This may not be the correct T-matrix if you changed any of the\n');
    fprintf('experiment parameters.\n\n')
    fprintf('In this case please delete tmatrix_penetrable_spheroid_example.mat\n');
...
% setup solver for scattering by a penetrable spheroid
slvr = solverEllipsoidPenetrable(kwave,[],x0,[1 1 ar],refin,[1 rho],m,2*m);
...
if ~loaded_tmatrix
    ...
    % save the T-matrix
    T.save('tmatrix_penetrable_spheroid_example.mat')
