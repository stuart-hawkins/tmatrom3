% Spherical Hannkel function
%
%  H = sphbesselh(n,x) computes the first kind spherical Hankel function of 
%  order n at points x. Here n or x may be vectors.
%
%  See Abramowitz and Stegun, Handbook of Mathematical Functions, 
%  Section 10.1.1.
%
% See also: sphbesselj, sphbesseljd, sphbesselhd.
%
...
function val = sphbesselh(n,x)

val = sqrt(0.5*pi./x) .* besselh(n+0.5,x);
