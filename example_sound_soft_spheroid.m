...
% This example:
%
% 1) Computes the T-matrix of a sound-soft spheroid
...
help example_sound_soft_spheroid
...
if exist('tmatrix_sound_soft_spheroid_example.mat','file')
    
    % load the T-matrix
    T = tmatrix('tmatrix_sound_soft_spheroid_example.mat');
...
if loaded_tmatrix
    ...
    fprintf('Warning:\n\n');
    fprintf('Loaded T-matrix from tmatrix_sound_soft_spheroid_example.mat.\n');
    fprintf('This may not be the correct T-matrix if you changed any of the\n');
    fprintf('experiment parameters.\n\n')
    fprintf('In this case please delete tmatrix_sound_soft_spheroid_example.mat\n');
...
% setup solver for sound soft scattering by a spheroid
slvr = solverEllipsoidSoft(kwave,[],x0,[1 1 ar],m,2*m);
...
if ~loaded_tmatrix
    ...
    % save the T-matrix
    T.save('tmatrix_sound_soft_spheroid_example.mat')
